...
public class RecyclerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinkedList data;
        MealCustomAdapter mealCustomAdapter;
        RecyclerView mealRecyclerView;

        data = new LinkedList();
        mealCustomAdapter = new MealCustomAdapter(data);
        mealRecyclerView = (RecyclerView) view.findViewById(R.id.viewRecyclerFrag);
        mealRecyclerView.setAdapter(mealCustomAdapter);
        mealRecyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));
